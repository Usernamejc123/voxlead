...
Required environment variables:
  ...
  MAKE_REPLY_WEBHOOK_URL     - Make.com hot-lead reply handler webhook URL
  INSTANTLY_API_KEY          - Instantly.ai API v2 key (for campaign + analytics)
  ANTHROPIC_API_KEY          - Claude AI key (icebreakers + reply classification)
...
PLANS = {
    "starter": {
        ...
        "features": [
            ...
            "AI reply agent (auto-handles responses)",
            "1 target industry",
